...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblArestas.setText("Arestas (edges):");
        lblArestas.setName("lblArestas"); // NOI18N

        lblVertices.setText("Vértices (nodes):");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(txtArestas, javax.swing.GroupLayout.DEFAULT_SIZE, 51, Short.MAX_VALUE))
                .addGap(167, 167, 167))
        );
    ...
    private void btnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarActionPerformed
        ...
        try{
            grafo.setAresta(parseInt(txtArestas.getText()));
            grafo.setVertice(parseInt(txtVertices.getText()));
            Storage.getInstance().setGrafo(grafo);
        }
